...
- You do not format the excerpt with markdown.
...
You can preview the markdown formatting using a free online viewer like: [https://markdownlivepreview.com](https://markdownlivepreview.com)